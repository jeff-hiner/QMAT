...
REM Q-MAT DLL Build with MSVC (32-bit)
REM Tests if 32-bit pointers improve cache efficiency like WASM
...
echo Building Q-MAT DLL with MSVC (32-bit)...

cl /nologo /EHsc /O2 /std:c++17 /DQMAT_NO_CGAL /LD /I src ^
    src\Wm4Math.cpp ^
    src\Wm4Matrix.cpp ^
    src\Wm4Vector.cpp ^
...
del *.obj *.exp >nul 2>&1
echo BUILD SUCCESS: qmat_x86.dll
dir /b qmat_x86.dll qmat_x86.lib
